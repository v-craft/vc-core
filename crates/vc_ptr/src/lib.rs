...
//! **ThinSlicePtr**
//!
//! [`ThinSlicePtr`] is a thin slice pointer that stores only a data pointer (no length),
//! making it smaller. Access through it is unsafe because bounds checks are not available;
//! in debug builds it may retain length information to aid debugging.
//!
//! **Ptr** and **PtrMut**
//!
