...
///
/// While custom type trait is often generated using the [`#[reflect_cast]`](crate::derive::reflect_cast) macro.
///
/// # Naming Convention
///
...
///
/// The TypeTrait generated by [`reflect_cast`] is prefixed with `ReflectCast`
/// because they only provide three fixed conversion methods `cast_ref`, `cast_mut` and `cast_boxed`,
/// See [`reflect_cast` macro attribute](crate::derive::reflect_cast) for more details.
///
/// # Implementation
///
/// ## Use [`#[reflect_cast]`](crate::derive::reflect_cast) macro
///
/// ```
/// use vc_reflect::{derive::reflect_cast, registry::FromType};
///
/// #[reflect_cast]
/// trait MyDisplay {
///     fn display(&self) { /* ... */ }
...
///
/// let reflect_trait = <ReflectCastMyDisplay as FromType<i32>>::from_type();
/// ```
///
/// ## Manually
///
