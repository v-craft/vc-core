...
///
/// This generates a struct that takes the form `ReflectCastMyTrait`. An instance of this struct can then be
/// used to perform the conversion.
pub(crate) fn impl_reflect_cast(input: TokenStream) -> TokenStream {
    ...
    TokenStream::from(quote! {
        ...
        #trait_vis struct #reflect_trait_ident {
            cast_ref_func: fn(&dyn #reflect_) -> #OptionFP<&dyn #trait_ident>,
            cast_mut_func: fn(&mut dyn #reflect_) -> #OptionFP<&mut dyn #trait_ident>,
            cast_boxed_func: fn(#macro_utils_::Box<dyn #reflect_>) -> #ResultFP<#macro_utils_::Box<dyn #trait_ident>, #macro_utils_::Box<dyn #reflect_>>,
        }
        ...
        impl #reflect_trait_ident {
            #[doc = #cast_ref_doc]
            #[inline]
            pub fn cast_ref<'a>(&self, reflect_value: &'a dyn #reflect_) -> #OptionFP<&'a dyn #trait_ident> {
                (self.cast_ref_func)(reflect_value)
            }

            #[doc = #cast_mut_doc]
            #[inline]
            pub fn cast_mut<'a>(&self, reflect_value: &'a mut dyn #reflect_) -> #OptionFP<&'a mut dyn #trait_ident> {
                (self.cast_mut_func)(reflect_value)
            }

            #[doc = #cast_box_doc]
            #[inline]
            pub fn cast_boxed(&self, reflect_value: #macro_utils_::Box<dyn #reflect_>) -> #ResultFP<#macro_utils_::Box<dyn #trait_ident>, #macro_utils_::Box<dyn #reflect_>> {
                (self.cast_boxed_func)(reflect_value)
            }
        }
