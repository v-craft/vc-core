...
impl Debug for RemoteAllocator {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_struct("RemoteAllocator")
            .field("total_allocated", &self.shared.fresh.count())
            .field("available_recycled", &self.shared.free.count())
            .finish()
    }
}
...
impl Debug for EntityAllocator {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_struct("EntityAllocator")
            .field("shared_fresh", &self.shared.fresh.count())
            .field("shared_free", &self.shared.free.count())
